...
(function(vue, shared) {
  ...
  const _sfc_main$3 = {
    setup(__props) {
      const title = "Welcome to KuLiao";
      function startmain() {
        uni.navigateTo({
          url: "/pages/startmain?id=2&name=test2"
        });
      }
      onLoad((options) => {
      });
      ...
      return (_ctx, _cache) => {
        return vue.openBlock(), vue.createElementBlock("view", { class: "content" }, [
          ...
          vue.createCommentVNode(' 		<navigator url="/pages/main?id=1&name=test" hover-class="navigator-hover">\r\n			<button type="default">\u8DF3\u8F6C\u5230\u65B0\u9875\u9762\u5E76\u4F20\u53C2</button>\r\n		</navigator> '),
  ...
  var PagesIndex = /* @__PURE__ */ _export_sfc(_sfc_main$3, [["__file", "E:/HBuilderProjects/KuLiao/pages/index.vue"]]);
  var axios$2 = { exports: {} };
  ...
  const _sfc_main$2 = /* @__PURE__ */ vue.defineComponent({
    setup(__props, { expose }) {
      const users = axios.get("https://jsonplaceholder.typicode.com/users").then((res) => {
        return res;
      });
      expose({ users });
      return (_ctx, _cache) => {
        return vue.openBlock(), vue.createElementBlock("div", { class: "container" }, [
          vue.createElementVNode("h3", null, "Users:"),
          vue.createElementVNode("table", { class: "table" }, [
            vue.createElementVNode("thead", null, [
              vue.createElementVNode("tr", null, [
                vue.createElementVNode("th", { scope: "col" }, "Id"),
                vue.createElementVNode("th", { scope: "col" }, "Name"),
                vue.createElementVNode("th", { scope: "col" }, "Email"),
                vue.createElementVNode("th", { scope: "col" }, "City")
              ])
            ]),
            vue.createElementVNode("tbody", null, [
              (vue.openBlock(true), vue.createElementBlock(vue.Fragment, null, vue.renderList(vue.unref(users), (user) => {
                return vue.openBlock(), vue.createElementBlock("tr", {
                  key: user.id
                }, [
                  vue.createElementVNode("th", { scope: "row" }, vue.toDisplayString(user.id), 1),
                  vue.createElementVNode("td", null, vue.toDisplayString(user.name), 1),
                  vue.createElementVNode("td", null, vue.toDisplayString(user.email), 1),
                  vue.createElementVNode("td", null, vue.toDisplayString(user.address.city), 1)
                ]);
              }), 128))
            ])
          ])
  ...
  var Users = /* @__PURE__ */ _export_sfc(_sfc_main$2, [["__scopeId", "data-v-790d6ab0"], ["__file", "E:/HBuilderProjects/KuLiao/pages/components/Users.vue"]]);
  const __default__ = {
    components: {
      Users
    }
  ...
  const _sfc_main$1 = /* @__PURE__ */ Object.assign(__default__, {
    setup(__props) {
      let params = null;
      let person = vue.reactive({ first: "firstname", last: "lastname" });
      const title = vue.ref(1);
      ...
      onShow(() => {
        formatAppLog("log", "at pages/startmain.vue:24", "onShow");
      });
      vue.onMounted(() => {
        formatAppLog("log", "at pages/startmain.vue:27", params);
      });
      onReady(() => {
        formatAppLog("log", "at pages/startmain.vue:30", "onReady");
      });
      return (_ctx, _cache) => {
        return vue.openBlock(), vue.createElementBlock(vue.Fragment, null, [
          vue.createElementVNode("view", { class: "content" }, [
            vue.createElementVNode("view", null, "title:" + vue.toDisplayString(title.value), 1),
            vue.createElementVNode("view", null, "received params: " + vue.toDisplayString(vue.unref(params)), 1),
            vue.createElementVNode("view", null, "fullname: " + vue.toDisplayString(vue.unref(fullname)), 1)
          ]),
          vue.createVNode(Users)
        ], 64);
      };
    }
  });
  var PagesStartmain = /* @__PURE__ */ _export_sfc(_sfc_main$1, [["__file", "E:/HBuilderProjects/KuLiao/pages/startmain.vue"]]);
  const _sfc_main = {};
  function _sfc_render(_ctx, _cache) {
    return vue.openBlock(), vue.createElementBlock("div", { id: "app" }, [
      vue.createElementVNode("button", {
        onClick: _cache[0] || (_cache[0] = ($event) => _ctx.count++)
      }, vue.toDisplayString(_ctx.count), 1)
    ]);
  }
  var App = /* @__PURE__ */ _export_sfc(_sfc_main, [["render", _sfc_render], ["__file", "E:/HBuilderProjects/KuLiao/App.vue"]]);
  __definePage("pages/index", PagesIndex);
  __definePage("pages/startmain", PagesStartmain);
  __definePage("App", App);
  function createApp() {
